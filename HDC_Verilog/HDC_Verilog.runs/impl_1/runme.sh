...
HD_PWD='C:/Users/student/Documents/Test/GAN_Malware/HDC_Verilog/HDC_Verilog.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_inference_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_inference_wrapper.tcl -notrace
