...
HD_PWD='C:/Users/student/Documents/Test/GAN_Malware/HDC_Verilog/HDC_Verilog.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_inference_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_inference_wrapper.tcl
